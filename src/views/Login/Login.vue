...
export default {
  ...
  methods:{
    ...
    jumpTo(){
      window.location.href = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx31dde80f95ebb3c8&redirect_uri=https%3A%2F%2Fmoneyboom.cn%2F%23%2FRegist&response_type=code&scope=snsapi_base&state=JuheFinbridge#wechat_redirect'
    },
  }
}
</script>
